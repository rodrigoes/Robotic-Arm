...
public class Cosimir_robo
    ...
    private void desenharBase (GL2 gl, double J1)
    {
        ...
        gl.glPushMatrix();
            ...
            glut.glutWireCylinder(1.2, 2, 10, 10);
         ...
         gl.glPushMatrix();
                ...
                gl.glPushMatrix();
                    ...
                    gl.glPushMatrix();
                        ...
                        gl.glRotated(90, 0, 1, 0);
                        glut.glutWireCylinder(0.75, 0.4, 10, 10);
    ...
    private void desenharPunho (GL2 gl, double J5, double J6)
    {
                        ...
                        gl.glPushMatrix();
                            ...
                            glut.glutWireCylinder(0.5, 0.4, 10, 10);
                            ...
                            glut.glutWireCylinder(0.7, 0.4, 10, 10);
                            
                            //J6
                            gl.glTranslated(0,0,-0.4);
                            gl.glRotated(J6, 0, 0, 1);
                            glut.glutWireCylinder(0.6, 0.4, 10, 10);
